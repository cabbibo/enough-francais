...
LoadBar.prototype.addText = function(){
  ...
  var forward = [
      "<p>Il est difficile pour moi de décrire la joie que j’éprouve en lisant un livre d’image, page après page. Ces dernières me permettent d’explorer des galaxies, de chevaucher des dinosaures, de terrasser des dragons. Grâce à elles, je peux explorer les tréfonds de ma personne et parier sur ma belle étoile, monter dans un train qui roule vers le Nord, ou m’élever dans le ciel à bord d’un avion de pâte à modeler.</p>",
      "<p>Je sais que je ne pourrais jamais recréer la splendeur, la magnificence, la beauté dont je suis témoin dans ces instants majestueux, mais j’espère que ce projet vous rappellera un peu les merveilles que sont la possibilité d’aller n’importe où, d’être qui l’on veut, de découvrir un brin de magie dans les instants les plus fragiles.</p>"
  ].join("\n");

  this.loadInfoDiv.innerHTML = "<h1>Avant-propos</h1>"
 ...
 // this.loadInfoDiv.innerHTML += ""
  ...
  this.loadInfoDiv.innerHTML += "Temps d'exploration : 20 - 30 min <br/>"
  this.loadInfoDiv.innerHTML += "Interaction : Cliquer sur le logo pour tourner les pages <br/>"
  this.loadInfoDiv.innerHTML += "Un casque audio est requis<br/><br/>"
